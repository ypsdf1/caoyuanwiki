...
本插件仅有简中语言版本，如需除简中以外的任何版本，请下载插件源码，自行修改！

## 云背包介绍

云背包插件，是由sdf1团队开发，为解决玩家物理存储空间有限、寻找物品困难而开发的。它允许玩家将自己的物品，寄托于云背包中，玩家不需要再为自己基地被盗、基地空间不够而担心。
...
[官方下载](https://pan.ypshidifu.cn/s/n6hG)
...
| 1.0 | 第一个测试版 | 测试版 |
| 1.1 | 第二个测试版，允许翻页 | 测试版 |
| 1.3 | 第一个正式版，加入商城、管理员面板等功能 | 正式版 |

## 注意事项

- 本项目由 Xiaomi Mimo 大模型开发
- 环境适配：JDK21 + Paper 1.21.1
- 本插件为免费插件，请勿商业转发
- 本插件为草原探险服务器定制插件，体验最新内测版，建议您游玩草原探险服务器或加入我们的[官方群 981954292](http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=ftGx3Ac2pd8IbWV5WZmoIrVHRXgGUb2a&authKey=DLTKLbiInzZe0pegvDtXbTVXeLJ6TAaPtHd3ol8p5adiljTSzzEp8hHU%2BLA4kBT4&noverify=0&group_code=981954292) 获取。
